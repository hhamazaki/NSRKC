...
void model_parameters::convert_parameters_into_rates(void)
{
 ...
 // calculate molitng and catchability function   
   ...
   selw(3) = 1.0/(1.0+mfexp(-1.0*sw1*(98.5-sw2)));
   selw(4) = 1.0/(1.0+mfexp(-1.0*sw1*(108.5-sw2)));
   selw(na) = sw3;
   ...
   selp(3) = 1.0/(1.0+mfexp(-1.0*sp1*(98.5-sp2)));
   selp(4) = 1.0/(1.0+mfexp(-1.0*sp1*(108.5-sp2)));
}
