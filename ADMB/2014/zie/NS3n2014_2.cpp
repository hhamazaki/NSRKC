...
model_data::model_data(int argc,char * argv[]) : ad_comm(argc,argv)
{
  ...
  tsc.allocate(1,ny,"tsc");
  tsct.allocate(1,ny,"tsct");
 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  log_relrec.allocate(1,ny,-20.,30.,2,"log_relrec");
  ...
  p4.allocate(0.1,1.0,1,"p4");
  log_rec.allocate(1,ny,"log_rec");
...
void model_parameters::initializationfunction(void)
{
  ...
  log_q2.set_initial_value(-6.5);
  log_q3.set_initial_value(-6.05);
