...
//===============================================================================================================
PARAMETER_SECTION
  init_bounded_number log_q1(-32.5,10.0,1)     //Commercial firherey Catchability 1977-1992
  ...
  init_bounded_dev_vector log_relrec(1,ny,-20.,30.,1)
  ...
  init_bounded_number log_st2(0.51,6.5,1)      //length at 50% selectivity: NOAA trawl survey
...
//  init_bounded_number log_sp2(3.9,5.50,1)      //length at 50% selectivity: pot survey : Not used
  init_bounded_number log_sw1(-10.0,1.0,1)      //parameter for selectivity: winter project
  ...
  init_bounded_number log_sc2(3.9,10.5,1)      //length at 50% selectivity: summer fishery before 1993
  ...
  init_bounded_number log_sc6(3.9,10.5,1)      //length at 50% selectivity: summer fishery after 2008: Not used
...
//===============================================================================================================
    ...
    for (j=1;j<=na;j++)
	{
     nps(j,i) = (npw(j,i)-enwp(j,i)*tsc(i)-enwc(j,i)*twc(i)-(twc(i)/tt1)*(npw(j,i))*selw(j)*(1-lg(j))*hm(2)-tscd(i)*enwpd(j,i)*hm(2))*exp(-0.417*Mn(j));
     ops(j,i) = (opw(j,i)-eowp(j,i)*tsc(i)-eowc(j,i)*twc(i)-(twc(i)/tt1)*(opw(j,i))*selw(j)*(1-lg(j))*hm(2)-tscd(i)*eowpd(j,i)*hm(2))*exp(-0.417*Mo(j));	
