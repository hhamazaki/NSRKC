 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  sel.allocate(1,na,fyear,lyear,"sel");
    ...
    sel.initialize();
  #endif
  st1.allocate(1,1,"st1");
  #ifndef NO_AD_INITIALIZE
    st1.initialize();
  #endif
  sc1.allocate(1,1,"sc1");
  #ifndef NO_AD_INITIALIZE
    sc1.initialize();
  #endif
