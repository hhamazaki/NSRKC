 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  log_alpha.allocate(-10.5,-1.0,-smol,"log_alpha");
  log_beta.allocate(0.5,5.5,-smol,"log_beta");
  ...
  log_st1.allocate(1,2,-15.0,1.0,-sst,"log_st1");
  ...
  log_sc1.allocate(1,3,0.5,5.0,-ssc,"log_sc1");
  log_sc2.allocate(1,3,-6.0,0.0,-ssc,"log_sc2");
...
void model_parameters::initializationfunction(void)
{
  ...
  log_beta.set_initial_value(4.7);
  log_st1.set_initial_value(-2.5);
  log_st2.set_initial_value(-2.0);
  log_sc1.set_initial_value(1.0);
  log_sc2.set_initial_value(-2.5);
