...
prefix1 <- paste(admodeldir,'Original/base/','ns3n2013cpue',sep='')
prefix2 <- paste(admodeldir,'Original/S3-1+qnhalf/','ns3n2013cpue',sep='')
prefix3 <- paste(admodeldir,'Original/S3-2+qM0.24/','ns3n2013cpue',sep='')
prefix4 <- paste(admodeldir,'Original/S3-3+qM0.30/','ns3n2013cpue',sep='')
prefix5 <- paste(admodeldir,'Original/S3-4+nhalf+M0.24/','ns3n2013cpue',sep='')
prefix6 <- paste(admodeldir,'Original/S3-5+nhalf+M0.30/','ns3n2013cpue',sep='')
prefix7 <- paste(admodeldir,'Original/S3-6+qnhalf+M0.24/','ns3n2013cpue',sep='')
prefix8 <- paste(admodeldir,'Original/S3-7-wocnalfpue-qnhalf-M0.30/','ns3n2013cpue',sep='')
prefix8 <- paste(admodeldir,'Original/S3-7+qnhalf+M0.30/','ns3n2013cpue',sep='')

legendtext <- c('BASE','S3-1','S3-2','S3-3','S3-4','S3-5','S3-6','S3-7')
