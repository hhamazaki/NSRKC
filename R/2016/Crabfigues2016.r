...
prefix <- paste(admodeldir,'ns3n2016_Feb1',sep='')
...
title(xlab = 'Implied Sample', line = 2)
title(ylab = 'Frequency', line = 2)
abline(v=mean(tefnn),lwd=2)

plot(tefnn,tefn, main='Trawl survey', xlim = c(0,dat$maxss),ylim=c(0,max(tefn)),xlab = 'Input sample', ylab = 'Implied sample')
abline(lm(tefn~ tefnn -1),lty=2)
lines(c(0,dat$maxss),c(0,dat$maxss))
title(xlab = 'Input Sample', line = 2)
title(ylab = 'Implied sample', line = 2)
plot(dat$it+1975, tefn,main='Trawl survey', xlab = 'Year', ylab = 'Implied sample' )
title(xlab = 'Year', line = 2)

# Commercial Catch Figure
hist(scefn,breaks=10, main='Commercial Catch')
abline(v=mean(scefnn),lwd=2)
title(xlab = 'Implied Sample', line = 2)
title(ylab = 'Frequency', line = 2)
...
title(xlab = 'Input Sample', line = 2)
title(ylab = 'Implied sample', line = 2)
plot(year[-c(1,16,dat$ny+1)], scefn,main='Commercial Catch')
title(xlab = 'Year', line = 2)
title(ylab = 'Implied sample', line = 2)
# Winter Pot Survey Figure
hist(wpefn,breaks=5, main='Winter pot survey')
abline(v=mean(wpefnn),lwd=2)
title(xlab = 'Implied Sample', line = 2)
title(ylab = 'Frequency', line = 2)
...
title(xlab = 'Input Sample', line = 2)
title(ylab = 'Implied sample', line = 2)
plot(dat$iw+1975, wpefn, main='Winter pot survey')
title(xlab = 'Year', line = 2)
title(ylab = 'Implied sample', line = 2)
# Observer Survey Figure
hist(opefn,breaks=10, main='Observer survey')
abline(v=mean(opefnn),lwd=2)
title(xlab = 'Implied Sample', line = 2)
title(ylab = 'Frequency', line = 2)
...
title(xlab = 'Input Sample', line = 2)
title(ylab = 'Implied sample', line = 2)
plot(dat$io+1975, opefn, main='Observer survey')
title(xlab = 'Year', line = 2)
title(ylab = 'Implied sample', line = 2)
# Tag recovery Figure
hist(enrecap,breaks=10, main='Tag recovery')
abline(v=mean(nrecap),lwd=2)
title(xlab = 'Implied Sample', line = 2)
title(ylab = 'Frequency', line = 2)
plot(nrecap, enrecap, main='Tag recovery',xlab = 'Input sample', ylab = 'Implied sample')
