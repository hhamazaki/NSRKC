...
# Make retro data
source('C:/Projects/Norton_Sound/NSCrab/Prediction_model/Models/R/2019/make_retro_data2019.R')
###############################################################################################
...
datadir2 <- paste('C:/Projects/Norton_Sound/NSCrab/Prediction_model/2019/Model/Model_Eval/')
infn <- paste(datadir,'ns3n2019_test.dat',sep='')
# outfn: output file name  
outfn <- paste(datadir2,'ns3n2019R',sep='')
